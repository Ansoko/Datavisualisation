# -*- coding: utf-8 -*-
"""
@author: Nicolas, David, Anne-Sophie
"""
...
author = pd.read_csv("dataset/author.csv", engine='python', error_bad_lines=False)
keyword = pd.read_csv("dataset/keyword.csv", engine='python', error_bad_lines=False)
publication = pd.read_csv("dataset/publication.csv", engine='python', error_bad_lines=False)
publication_author = pd.read_csv("dataset/publication_author.csv", engine='python', error_bad_lines=False)
publication_keyword = pd.read_csv("dataset/publication_keywords.csv", engine='python', error_bad_lines=False)
publication_venue = pd.read_csv("dataset/publication_venue.csv", engine='python', error_bad_lines=False)
publication_year = pd.read_csv("dataset/publication_year.csv", engine='python', error_bad_lines=False)
venue = pd.read_csv("dataset/venue.csv", engine='python', error_bad_lines=False)
year = pd.read_csv("dataset/year.csv", engine='python', error_bad_lines=False)
...
donneesName = {'author': 'name_author', 'publication': 'article_title', 'venue':'name_venue', 'keyword':'keyword', 'year': 'year'}
